  ...
  return (
    <Layout>
        ...
        pt-25 pb-6 px-4 sm:px-6 lg:px-8'>
            ...
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-teal-50 to-teal-100 dark:from-amber-50 dark:to-amber-100 text-gray-600 font-semibold text-sm md:text-xl px-4 py-2 rounded-full shadow-sm">
                <span>🌍 Explore smarter. Discover deeper. Travel with <span className="text-teal-600 font-bold">WorldWise</span>.</span>
            </div>
            {/* <div className="inline-flex items-center gap-3 bg-gradient-to-r from-teal-50 to-teal-100 dark:from-gray-100 dark:to-gray-400 text-gray-600 font-semibold text-sm md:text-xl px-4 py-2 rounded-full shadow-sm">
                <span>🌍 Explore smarter. Discover deeper. Travel with <span className="text-teal-600  font-bold">WorldWise</span>.</span>
            </div> */}
                ...
                <p className="mt-6 text-lg md:text-xl text-gray-600 dark:text-teal-100 max-w-xl">
                ...
                <a href="/Countries" className="text-sm lg:text-xl font-medium inline-flex items-center gap-2 mt-4 bg-teal-600 hover:bg-teal-700 text-white dark:text-teal-100 dark:bg-teal-800 dark:hover:bg-teal-900 px-10 py-3 rounded-lg transition">
                    Learn More 
